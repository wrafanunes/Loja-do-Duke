...
namespace Loja_do_Duke.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, IEmailSender sender, UrlEncoder encoder, RoleManager<IdentityRole> roleManager, ApplicationDbContext context)
        {
        ...
        public async Task<IActionResult> Register(string returnUrl = null)
        {
            ...
            var identityUsers = _context.UserRoles.Where(u => u.RoleId == role.Id);
            if (!await _roleManager.RoleExistsAsync("Admin"))
            {
                //criar roles
                await _roleManager.CreateAsync(new IdentityRole("Admin"));
                await _roleManager.CreateAsync(new IdentityRole("User"));
                if (identityUsers.Count() < 2) await _roleManager.CreateAsync(new IdentityRole("SuperAdmin"));
            }
        ...
        public async Task<IActionResult> Register(RegisterVM model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    else if(model.SelectedRole != null && model.SelectedRole.Length > 0 && model.SelectedRole == "User")
                    {
        ...
        public async Task<IActionResult> EnableAuthenticator()
        {
            ...
            string AuthenticatorUri = string.Format(AuthenticatorUriFormat, _encoder.Encode("LojaDuke"),
